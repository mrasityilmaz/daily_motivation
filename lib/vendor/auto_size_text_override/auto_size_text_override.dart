...
//   /// Creates a [CustomAutoSizeText] widget.
//   ///
...
//   /// Creates a [CustomAutoSizeText] widget with a [TextSpan].
//   const CustomAutoSizeText.rich(
...
//   /// Synchronizes the size of multiple [CustomAutoSizeText]s.
//   ///
//   /// If you want multiple [CustomAutoSizeText]s to have the same text size, give all
//   /// of them the same [CustomAutoSizeGroup] instance. All of them will have the
//   /// size of the smallest [CustomAutoSizeText]
//   final CustomAutoSizeGroup? group;
...
//   @override
//   CustomAutoSizeTextState createState() => CustomAutoSizeTextState();
// }

// class CustomAutoSizeTextState extends State<CustomAutoSizeText> {
//   @override
//   void initState() {
//     super.initState();
...
//   @override
//   void didUpdateWidget(CustomAutoSizeText oldWidget) {
...
//           style = style.copyWith(fontSize: CustomAutoSizeText._defaultFontSize);
//         }
