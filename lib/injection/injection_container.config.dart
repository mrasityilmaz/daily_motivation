...
import '../data/repositories/example_repo/data_sources/example_mock_repository.dart'
    as _i6;
import '../data/repositories/example_repo/example_repository.dart' as _i12;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i11.IExampleRepository>(() => _i12.ExampleRepository(
        remoteDataSource: gh<_i4.IExampleRemoteRepository>(),
        localDataSource: gh<_i13.IExampleLocalRepository>(),
