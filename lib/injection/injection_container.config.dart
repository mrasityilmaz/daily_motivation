...
import '../data/repositories/example_repo/data_sources/example_mock_repository.dart'
    as _i7;
import '../data/repositories/example_repo/example_repository.dart' as _i15;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i14.IExampleRepository>(() => _i15.ExampleRepository(
        remoteDataSource: gh<_i5.IExampleRemoteRepository>(),
        localDataSource: gh<_i16.IExampleLocalRepository>(),
