...
class UserNotificationScheduleTimesMapper
  ...
  static List<ScheduleTime> _$whichTimesOfDay(
          UserNotificationScheduleTimes v) =>
      v.whichTimesOfDay;
  static const Field<UserNotificationScheduleTimes, List<ScheduleTime>>
...
abstract class UserNotificationScheduleTimesCopyWith<
  ...
  ListCopyWith<$R, WeekdayEnum, ObjectCopyWith<$R, WeekdayEnum, WeekdayEnum>>
      get whichDaysOfWeek;
  ListCopyWith<$R, ScheduleTime, ObjectCopyWith<$R, ScheduleTime, ScheduleTime>>
      get whichTimesOfDay;
  $R call(
      {List<WeekdayEnum>? whichDaysOfWeek,
      List<ScheduleTime>? whichTimesOfDay});
...
class ScheduleTimeMapper extends RecordMapperBase<ScheduleTime> {
  ...
  static ScheduleTimeMapper ensureInitialized() {
    if (_instance == null) {
      ...
      MapperBase.addType(<A, B>(f) => f<({A hour, B minute})>());
    }
    return _instance!;
  }
...
extension ScheduleTimeValueCopy<$R>
    on ObjectCopyWith<$R, ScheduleTime, ScheduleTime> {
  ScheduleTimeCopyWith<$R> get $asScheduleTime =>
      $base.as((v, t, t2) => _ScheduleTimeCopyWithImpl(v, t, t2));
}

abstract class ScheduleTimeCopyWith<$R>
    implements RecordCopyWith<$R, ScheduleTime> {
  $R call({Uint8? hour, Uint8? minute});
  ScheduleTimeCopyWith<$R2> $chain<$R2>(Then<ScheduleTime, $R2> t);
}

class _ScheduleTimeCopyWithImpl<$R> extends RecordCopyWithBase<$R, ScheduleTime>
    implements ScheduleTimeCopyWith<$R> {
  _ScheduleTimeCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final RecordMapperBase<ScheduleTime> $mapper =
      ScheduleTimeMapper.ensureInitialized();
  @override
  $R call({Uint8? hour, Uint8? minute}) => $apply(FieldCopyWithData(
