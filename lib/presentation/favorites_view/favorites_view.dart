          ...
          sliver: SliverList.builder(
            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: ListTile(
                  tileColor: context.appColors.surfaceColor.withOpacity(.1),
                  title: Text(viewModel.likedQuoteList[index].quote),
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      Text(
                        '-${viewModel.likedQuoteList[index].author}',
                        style: context.textTheme.titleSmall?.copyWith(color: context.colors.onBackground, fontWeight: FontWeight.w600),
                      ),
                      Text(
                        viewModel.likedQuoteList[index].category.tr(),
                        style: context.textTheme.titleSmall?.copyWith(color: context.colors.onBackground.withOpacity(.5), fontWeight: FontWeight.w600),
                      ),
                    ],
                  ),
                  isThreeLine: true,
              ...
              return Padding(
                ...
                child: Column(
                  ...
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Text(viewModel.likedQuoteList[index].quote),
                    SizedBox(height: context.lowValue * .2),
                    Text(
                      '-${viewModel.likedQuoteList[index].author}',
                      style: context.textTheme.titleSmall?.copyWith(color: context.colors.onBackground, fontWeight: FontWeight.w600),
                    ),
                    SizedBox(height: context.lowValue * .1),
                    Text(
                      viewModel.likedQuoteList[index].category.tr(),
                      style: context.textTheme.titleSmall?.copyWith(color: context.colors.onBackground.withOpacity(.5), fontWeight: FontWeight.w600),
                    ),
