...
import 'package:quotely/presentation/views/sign_bottom_sheets/signup_bottom_sheet/viewmodel/base_signup_viewmodel.dart';

// Ignore Reason: The [SignUpViewModelInterface] just created for this view model and testing purposes
...
final class SignUpViewModel extends SignUpViewModelInterface with NestedScrollableFocus {
  SignUpViewModel({
    ...
    // It's start listening to the focus nodes
    initFocusListener();
  }
