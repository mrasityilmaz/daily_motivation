...
// import 'package:quotely/data/models/received_notification_model/received_notification_model.dart';
...
//       builder: (BuildContext context) => AlertDialog(
//         content: Text(
//           areEnabled == null ? 'ERROR: received null' : (areEnabled ? 'Notifications are enabled' : 'Notifications are NOT enabled'),
//         ),
//         actions: <Widget>[
//           TextButton(
//             onPressed: () {
